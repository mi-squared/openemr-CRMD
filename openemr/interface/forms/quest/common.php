...
<?php } ?>
			...
			function addCodeRow(code,text) {
				...
				newRow += "<td class='wmtLabel' style='width:120px'><input name='dx_code[]' class='wmtFullInput code' style='font-weight:bold' readonly value='";
				newRow += code;
							        ...
							        <tr>
										<td class="wmtLabHeader wmtColorHeader">
											...
											<div style="float:left;vertical-align:bottom;">
												<input class="wmtButton" type="button" style="margin-top:2px;vertical-align:top" onclick="addCodes()" value="add selected"/>
											</div>
											<div style="float:right">
												<input class="wmtInput" style="background-color:white;vertical-align:top" type="text" name="searchIcd" id="searchIcd" />
...
foreach ($dlist as $data) {
	...
	echo "<tr><td style='white-space:nowrap;width:60px'><input class='wmtCheck' type='checkbox' id='check_".$id."' code='ICD10:".$data['code']."' desc='".htmlspecialchars($text)."' > <b>".$data['code']."</b></input> - </td><td style='padding-top:4px'>".$text."</td></tr>\n";
}
								...
								<fieldset>
									...
									<table id="codeTable" style="width:100%">
										<tr>
											...
											<th class="wmtHeader" style="width:120px">Diagnosis Code</th>
...
<?php if ($lab_data['npi'] != 'QUEST' && $lab_data['recv_fac_id'] != 'QBA') { ?>
											<td style="text-align:right;min-width:65px">
												...
												<input type="text" class="wmtInput" style="width:65px" name='specimen_volume' id='specimen_volume'
...
?>
										...
										<td nowrap>
											<select class="wmtInput" name="request_account" style="max-width:200px" />
<?php 
