...
CALL lab_table_update(@db,"procedure_order","patient_instuctions","TEXT DEFAULT NULL");
...
CALL lab_table_update(@db,"procedure_order_code","pocedure_type","VARCHAR(31) DEFAULT NULL");
...
('lists', 	'Lab_Categoy', 			'Lab Categoy', 			0, 1, 0, '', 'ID=appt code TITLE=orphan results', ''),
...
('Lab_Form_Status', 	'n', 			'Pending Notification', 	7, 0, 0, '', 'DO NOT CHANGE', ''),
('Lab_Form_Status', 	's', 			'Order Submitted', 			2, 0, 0, '', 'DO NOT CHANGE', ''),
('Lab_Form_Status', 	'v', 			'Pending Review', 			6, 0, 0, '', 'DO NOT CHANGE', ''),
