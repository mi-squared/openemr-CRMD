...
<title><?php xl('Laboratory Batch Result Processing','e'); ?></title>
...
<script>
	function doSubmit() {
		if ($('#lab_id').val() == '') {
			alert("Laboratory processor required for execution!!");
			return false;
		}
		else {
...
<body class="body_top">
<span class='title'><?php xl('Lab Batch Processing','e'); ?></span>
