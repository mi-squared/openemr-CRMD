...
<table nobr="true" style="width:100%;border:1px solid black;padding:0 5px">
	<tr>
		...
		<td style="width:20%;border:1px solid black">
			...
			<b><?php echo ($message->speciment_datetime) ? date('Y-m-d h:i A', strtotime($message->specimen_datetime)) : '' ?></b>
		</td>
		<td style="width:20%;border:1px solid black">
...
<table nobr="true" style="width:100%;border:1px solid black;padding:0 5px">
	...
	<tr>
		<td style="border:1px solid black">
			...
			<b><?php echo ($patient->pubpid) ? $patient->pid : ''; // pid displayed as pubpid above if pubpid missing ?></b>
		</td>
		<td style="border:1px solid black">
