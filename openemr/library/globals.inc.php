   ...
   'pdf_layout' => array (
    ...
    'pdf_language' => array (  
       ...
       array(
            ...
            'mt' => xl('Maltese'),
            'mi' => xl('MÄ�ori'),
            'mr' => xl('Marathi (MarÄ�á¹­hÄ«)'),
            'mh' => xl('Marshallese'),
            'mn' => xl('Mongolian'),
            'na' => xl('Nauru'),
            'nv' => xl('Navajo, Navaho'),
            'nb' => xl('Norwegian BokmÃ¥l'),
            'nd' => xl('North Ndebele'),
            'ne' => xl('Nepali'),
            'ng' => xl('Ndonga'),
            ...
            'oc' => xl('Occitan'),
            'oj' => xl('Ojibwe, Ojibwa'),
            'cu' => xl('Old Church Slavonic,Â Church Slavonic,Â Old Bulgarian'),
            'om' => xl('Oromo'),
            'or' => xl('Oriya'),
            'os' => xl('Ossetian, Ossetic'),
            'pa' => xl('Panjabi, Punjabi'),
            'pi' => xl('PÄ�li'),
            'fa' => xl('PersianÂ (Farsi)'),
            'pl' => xl('Polish'),
            'ps' => xl('Pashto, Pushto'),
            'pt' => xl('Portuguese'),
            'qu' => xl('Quechua'),
